...
namespace FacturasAlegra_Dispatcher
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the DataRowToDictionary.cs
        /// </summary>
        /// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void DataRowToDictionary(System.Boolean isolated = false)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"DataRowToDictionary.cs", new Dictionary<string, object> { }, default, isolated, default, GetAssemblyName());
        }
