...
namespace FacturasAlegra_Dispatcher
{
    ...
    {
        private Lazy<global::FacturasAlegra_Dispatcher.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::FacturasAlegra_Dispatcher.WorkflowRunnerService>(() => new global::FacturasAlegra_Dispatcher.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::FacturasAlegra_Dispatcher.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
